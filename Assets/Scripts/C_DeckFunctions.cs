...
{
    /// <summary>
    /// Fonction qui cr�e une user story et l'ajoute � la liste des users stories
    /// </summary>
    ...
    /// <summary>
    /// Fonction de sauvegarde automatique du deck en .json. Le deck doit avoir �t� pr�alablement charg�
    /// </summary>
    ...
    /// <param name="deckTitle">Titre du deck ("Titre" par d�faut s'il n'est pas renseign�)</param>
    ...
    /// <summary>
    /// Fonction qui charge le deck � partir d'un .json
    /// </summary>
    /// <returns>Deck charg� ou null en cas de probl�me</returns>
    ...
    /// <summary>
    /// Fonction qui v�rifie le titre (non vide et pas d�j� utilis�)
    /// </summary>
    /// <param name="title">Titre de la user story</param>
    /// <param name="us_list">Liste qui contient les users stories</param>
    ...
    static bool CheckTitle(string title, List<USData> us_list)
    {
        if (title != "")
        {
            for (int i = 0; i < us_list.Count; i++)
            {
                ...
                {
                    Debug.Log("Titre d�j� utilis� pour une autre user story");
                    return false;
                }
            }
            return true;
        }
        Debug.Log("Il faut renseigner un titre � la user story");
        return false;
    }
    ...
    /// </summary>
    /// <param name="deck">Deck � log</param>
